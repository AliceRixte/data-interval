...
prop_member_intersectSetAndIntervalSet :: Property
prop_member_intersectSetAndIntervalSet =
  forAll arbitrary $ \(s :: Set Rational) ->
    forAll arbitrary $ \i ->
      forAll arbitrary $ \k ->
      (IntervalSet.member k i && Set.member k s) ===
          Set.member k (IntervalSet.intersectSetAndIntervalSet s i)

prop_intersectSetAndIntervalSet_same_as_filter :: Property
prop_intersectSetAndIntervalSet_same_as_filter =
  forAll arbitrary $ \(s :: Set Rational) ->
    forAll arbitrary $ \i ->
      IntervalSet.intersectSetAndIntervalSet s i ===
