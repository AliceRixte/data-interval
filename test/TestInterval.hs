...
prop_member_intersectSetAndInterval :: Property
prop_member_intersectSetAndInterval =
  forAll arbitrary $ \(s :: Set Rational) ->
    forAll arbitrary $ \(i :: Interval Rational) ->
      ...
      (Interval.member k i && Set.member k s) ===
          Set.member k (Interval.intersectSetAndInterval s i)

prop_intersectSetAndInterval_same_as_filter :: Property
prop_intersectSetAndInterval_same_as_filter =
  forAll arbitrary $ \(s :: Set Rational) ->
    forAll arbitrary $ \(i :: Interval Rational) ->
      Interval.intersectSetAndInterval s i ===
